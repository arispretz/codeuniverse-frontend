/**
 * @fileoverview NewListModal component.
 * Provides a modal dialog to create a new local list.
 * Includes form fields for list name and due date, and handles submission to the backend.
 *
 * @module components/modals/NewListModal
 */
...
import { createLocalList } from "../../services/projectService.js";
 ...
 * @returns {JSX.Element} Modal dialog component for creating a new local list.
 *
 * @example
 * <NewListModal
 *   open={isOpen}
 ...
 * />
 */
const NewListModal = ({ open, onClose, projectId, onCreated }) => {
  ...
  const handleCreate = async () => {
    ...
    setLoading(true);
    try {
      const data = await createLocalList(projectId, {
        name,
