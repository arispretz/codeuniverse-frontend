/**
 * @fileoverview PersonalTasksBoard component.
 ...
 *
 * @module pages/PersonalTasksBoard
 */
...
const PersonalTasksBoard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const newTask = await createPersonalTask({
        ...
        status: "todo", // ensure backend status is valid
      });
  ...
  const handleUpdate = async () => {
    try {
      const updatedTask = await updatePersonalTask(selectedTask._id, {
        ...form,
  ...
  return (
    <Box sx={{ p: 2 }}>
      <Typography variant="h5">🧍 Personal Tasks</Typography>
      <TextField
        label="Title"
        fullWidth
        value={form.title}
...
export default PersonalTasksBoard;
